...
describe( 'Accounts Merge', () => {
  ...
  it( 'e.g. 1', () => {
    ...
    const output = [['John','john00@mail.com','john_newyork@mail.com','johnsmith@mail.com'],['Mary','mary@mail.com'],['John','johnnybravo@mail.com']];
    expect( accountsMerge( accounts ).sort() ).toStrictEqual( output.sort() );
  } );
  ...
  it( 'e.g. 2', () => {
    ...
    const output = [['Ethan','Ethan0@m.co','Ethan4@m.co','Ethan5@m.co'],['Gabe','Gabe0@m.co','Gabe1@m.co','Gabe3@m.co'],['Hanzo','Hanzo0@m.co','Hanzo1@m.co','Hanzo3@m.co'],['Kevin','Kevin0@m.co','Kevin3@m.co','Kevin5@m.co'],['Fern','Fern0@m.co','Fern1@m.co','Fern5@m.co']];
    expect( accountsMerge( accounts ).sort() ).toStrictEqual( output.sort() );
  } );
